...
\- \*\*GitHub\*\* falls between both --- it's an interactive web app
...
\| \*\*Request Sent\*\* \| 2 ms \| Browser sent the HTTP GET request to
the server. \|
...
\- It works on \*\*port 80\*\* and sends information as \*\*plain
